...
public partial class SmoothStackedMountainDemo : ComponentBase
{
    [Inject]
    private ILogger<SmoothStackedMountainDemo> Logger { get; set; } = null!;

    private SciChartSurface? _sciChartRef;
    private XyDataSeries? _xyDataSeriesSmoothSeries1Ref;
    private XyDataSeries? _xyDataSeriesSmoothSeries2Ref;
    private XyDataSeries? _xyDataSeriesSmoothSeries3Ref;
    ...
    {
        if (_xyDataSeriesSmoothSeries1Ref == null) return;
