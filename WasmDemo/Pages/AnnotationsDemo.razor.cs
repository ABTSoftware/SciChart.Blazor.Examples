...
public partial class AnnotationsDemo : ComponentBase
{
    ...
    protected override void OnInitialized()
    {
        ...
        _horizontalLineAnnotations.Add(new HorizontalLineAnnotation { Id = "hline1", Y1 = 5.5, Stroke = "#9C27B0", StrokeThickness = 2, StrokeDashArray = new double[] { 5, 5 }, ShowLabel = true, AxisLabelStroke = "#9C27B0", AxisLabelFill = "#9C27B088", AxisFontSize = 14, AxisFontFamily = "Arial", LabelPlacement = ELabelPlacement.Axis, LabelValue = "Horizontal Line", DragOnLine = true, DragOnLabel = true, HorizontalAlignment = EHorizontalAlignment.Right, VerticalAlignment = EVerticalAlignment.Center, IsEditable = true });
        _verticalLineAnnotations.Add(new VerticalLineAnnotation { Id = "vline1", X1 = 4.5, Stroke = "#FF9800", StrokeThickness = 3, StrokeDashArray = new double[] { 10, 5 }, ShowLabel = true, AxisLabelStroke = "#FF9800", AxisLabelFill = "#FF980088", AxisFontSize = 14, AxisFontFamily = "Arial", LabelPlacement = ELabelPlacement.Axis, LabelValue = "Vertical Line", DragOnLine = true, DragOnLabel = true, HorizontalAlignment = EHorizontalAlignment.Center, VerticalAlignment = EVerticalAlignment.Bottom, IsEditable = true });
        _textAnnotations.Add(new TextAnnotation { Id = "text2", X1 = 0.5, Y1 = 9.5, Text = "SVG Text Annotation", TextColor = "#FFFFFF", FontSize = 16, FontFamily = "Arial", FontWeight = "bold", Background = "#00BCD4", Padding = new Thickness { left = 10, right = 10, top = 5, bottom = 5 }, XCoordShift = 0, YCoordShift = 0, VerticalAnchorPoint = EVerticalAnchorPoint.Top, HorizontalAnchorPoint = EHorizontalAnchorPoint.Left, IsEditable = true });
    }
