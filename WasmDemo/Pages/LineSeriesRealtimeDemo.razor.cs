...
public partial class LineSeriesRealtimeDemo : ComponentBase, IDisposable
{
    ...
    private bool _isCompressionMode = false;
    private EAutoRange _xAutoRange = EAutoRange.Never;
    private EZoomState _zoomState = EZoomState.AtExtents;
    ...
    private void HandleSurfaceRendered(SciChartSurfaceDefinition chartState)
    {
        try
        {
            ...
            _zoomState = chartState?.ZoomState ?? _zoomState;
